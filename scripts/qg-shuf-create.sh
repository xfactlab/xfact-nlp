...
vessl experiment create \
  ...
  --working-dir /root/deardr --root-volume-size "100Gi" --output-dir "/input/output${OUT_FILE}/" \
  ...
  -h val_reader=kilt -h train_db=wiki-pretraining -h val_db=kilt -h train_file=qg_5.jsonl -h val_file=trivia-5.json \
